...
class TestAddInvalidActionVolleyballPBP(unittest.TestCase):
    ...
    def test_invalid_action_play(self):
        ...
        expected_msg = "Odin: La acción indicada no está cubierta por PBP de Voleibol."
    ...
    def test_more_params_play(self):
        ...
        expected_msg = "Odin: Información de la acción (data) debe tener 2 parámetros para una notificación y 3 para una acción de jugada."
        self.assertEqual(response.status_code, 500)
        self.assertMultiLineEqual(expected_msg, response.json["ERROR"])
    ...
    def test_message_limit_notification(self):
        ...
        expected_msg = "Odin: El mensaje debe debe tener entre 1 y 100 caracteres."
        self.assertEqual(response.status_code, 500)
        self.assertMultiLineEqual(expected_msg, response.json["ERROR"])
    ...
    def test_more_params_notification(self):
        ...
        expected_msg = "Odin: Las notificaciones solo deben tener tipo de acción y mensaje."
        self.assertEqual(response.status_code, 500)
        self.assertMultiLineEqual(expected_msg, response.json["ERROR"])
