...
class SportHandler:
    ...
    ## @brief         Internal method for building a dictionary per sport row obtained from DAO.
    #
    #
    # @protected
    ...
    ## @brief         Internal method for building the list of sports into a list of dictionaries.
    #
    #
    # @protected
