...
class UserHandler:
    ## @brief         Converts a record returned by the DAO into a dictionary.
    #
    ...
    ## @brief         Converts results returned by DAO into a dictionary.
    #
    ...
    #
    #
    # @param		username	The usernamename of the new dashboboard user.
    # @param		full_name	The name of the new dashboboard user.
    ...
    ## @brief         Gets a dashboard's user password hash given their username.
    #
    ...
    #
    # @param		username	The username of the dashboboard user that needs to be fetched.
    # @param		password	The password of the dashboard user
    # @return
    ...
    ## @brief         Updates the password for the dashboard user with the given ID and sets is_active status.
    #
    ...
    ## @brief         Toggle the active status of a dashboard user.
    #
    ...
    ## @brief         Adds permissions to a user.
    #
    ...
    # @param		permissionsList	A list of the permissions to add to the user.
    #
    # @return
    ...
    # @param		selector	Determines if the method will be used internally by handler or will be used to return a request response.
    # @return
