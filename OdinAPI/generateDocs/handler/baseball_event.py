...
#===========================//II.POSTS//====================================
    ...
    def addStatistics(self,eID,aID,attributes): # Instantiates a Baseball Event DAO in order to complete the desired post request and it returns a JSON with either a confirmation or error message.
        ...
        try:
            ...
            if dao.getBaseballEventID(eID,aID):
                return jsonify(Error = "Baseball Event Entry already exists for Event ID:{} and Athlete ID:{}".format(eID,aID)),403 #TODO: Use 403 for duplicates
        except:
    ...
    def addTeamStatistics(self,eID,attributes): # Instantiates a Baseball Event DAO in order to complete the desired post request and it returns a JSON with either a confirmation or error message.
    ...
    def addTeamStatisticsAuto(self,eID): # Instantiates a Baseball Event DAO in order to complete the desired post request and it returns a JSON with either a confirmation or error message.
...
#===========================//III.PUTS//====================================
    ...
    def editStatistics(self,eID,aID,attributes): # Instantiates a Baseball Event DAO in order to complete the desired put request and it returns a JSON with either a confirmation or error message.
    ...
    ## @brief         Updates the team statistics for the baseball event with the given ID and aggregates of existing data.
    #
    #        Calls the BasktballEventDAO to update the statistics of a baseball event. It then
    #        maps the result to a JSON that contains the desired record. That JSON
    #        object is then returned.
    ...
    def editTeamStatistics(self,eID): # Instantiates a Baseball Event DAO in order to complete the desired put request and it returns a JSON with either a confirmation or error message.
...
#===========================//IV.REMOVE//====================================
    ...
    def removeStatistics(self,eID,aID): # Instantiates a Baseball Event DAO in order to complete the desired put request and it returns a JSON with either a confirmation or error message.
