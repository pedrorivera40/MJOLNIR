...
class VolleyballPBPHandler:
    ...
    ## @brief  	Default	initialize keywords that apply to Volleyball PBP sequences.
    #
    ...
    ## @brief         Internal method to determine set path directly depending on the action team.
    #
    #
    # @protected
    ...
    ## @brief         Internal method to obtain the indirect set path. It is the complement of the direct set path.
    #
    #
    # @protected
    ...
    ## @brief         Internal method for handling Volleyball PBP Actions via a PBPDao.
    #
    #
    # @protected
    ...
    ## @brief         Internal method for handling editting previously added game actions in a PBP sequence.
    #
    #
    # @protected
    ...
    ## @brief         Internal method for handling PBP actions removal and its effects over current score.
    #
    #
    # @protected
