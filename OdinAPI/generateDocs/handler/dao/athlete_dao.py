...
class AthleteDAO:
    ...
    ## @brief         Returns all the athletes that are valid in the database.
    #
    ...
    #
    #
    # @param		sID	The id of the sport that has participant athletes.
    # @return
    ...
    #
    #
    # @param		aID	The id of the athlete to be fetched.
    # @return
    ...
    ## @brief         Adds a new athlete into the database with the information given.
    #
    ...
    #
    #
    # @param		sID	The id of the sport in which the athlete will participate.
    # @param		aFName	First name of the athlete
    # @param		aMName	Middle name of the athlete
    # @param		aLName	Last name of the athlete
    # @param		aBio	Short bio of the athlete
    #            aHeight:Height of the athlete in inches
    # @param		aStudyProgram	Study Program of the athlete
    # @param		aDateOfBirth	Data of birth of the athlete.
    #            aSchoolOfPrecedence:School of Precedence of the athlete.
    # @param		aNumber	Number of the athlete in the sport.
    # @param		aYearOfStudy	Number of years the athlete has been studying.
    # @param		aYearsOfParticipation	Number of years the athlete has participated in the sport.
    # @param		aProfilePictureLink	Link for the image of the athlete profile
    # @return
    ...
    # @param		aYearsOfParticipation	Number of years the athlete has participated in the sport.
    # @param		aProfilePictureLink	Link for the image of the athlete profile.
    # @param		aPositions	A dictionary containing the positions of the athelete in
    #                        a sport given.
    # @return
    #            The id of the newly added athlete.
    #
    ...
    # @param		aYearsOfParticipation	Number of years the athlete has participated in the sport.
    # @param		aProfilePictureLink	Link for the image of the athlete profile.
    # @param		aCategories	A dictionary containing the categories of the athelete in
    #                        a sport given.
    # @return
    #            The id of the newly added athlete.
    #
    ...
    #
    #
    # @param		aID	The id of athlete to be updated.
    # @param		aFName	First name of the athlete
    # @param		aMName	Middle name of the athlete
    # @param		aLName	Last name of the athlete
    # @param		aBio	Short bio of the athlete
    ...
    ## @brief         Invalidates an athlete on the database.
    #
    ...
    #
    #
    # @param		aID	The id of the athlete to invalidate.
    #
    # @return
    ...
    # @param		sID	The id of the sport being confirmed
    # @return
