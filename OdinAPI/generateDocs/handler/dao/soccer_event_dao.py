...
#=============================//HELPERS//====================
    ...
    ## @brief         Checks if soccer event exists.
    #
    ...
    ## @brief         Checks if invalid soccer event exists.
    #
    #        This function uses IDs to perform a query to the database
    ...
    ## @brief         Checks if soccer event team stats exist.
    #
    #        This function uses IDs to perform a query to the database
    #        that verifies if the Soccer Event exists.
    #
    ...
    ## @brief         Checks if invalid soccer event team stats exist.
    #
    #        This function uses IDs to perform a query to the database
    #        that verifies if the invalid Soccer Event exists.
    #
...
#=============================//GETS//=======================
    ...
    #
    #
    # @param		sID	the sport id for the soccer branch of which statistics need to be fetched
    # @param		seasonYear	the season year of which statistics need to be fetched.
    #
    #
    # @return
...
#=============================//POST//=======================
    ...
    ## @brief         Adds a new soccer event statistics record with the provided information.
    #
    ...
    def addStatistics(self,eID,aID,goal_attempts,assists,fouls,cards,successful_goals,tackles,):
        ...
        query = """
                ...
                """
        cursor.execute(query,(int(goal_attempts),int(assists),int(fouls),int(cards),int(successful_goals),int(tackles),int(eID),int(aID),))
    ...
    ## @brief         Adds a new soccer event team statistics record with the provided information.
    #
    ...
    ## @brief         Adds a new soccer event team statistics record with provided and existing information.
    #
...
#=============================//DELETE//=======================
    ...
    ## @brief         Invalidates a soccer event statistics entry in the database.
    #
    ...
    ## @brief         Invalidates a soccer event team statistics entry in the database.
    #
