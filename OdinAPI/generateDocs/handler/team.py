...
#===========================//DICTIONARY MAPPERS//==================================
    ...
    ## @brief         Gets all the teams in the system that match the given sport id.
    #
    #        Calls the TeamDAO to get team entries and maps the result
    ...
    #
    #
    # @param		sID	the ID of the sport of which the teams will be returned
    #
    # @return
    ...
    ## @brief         Gets the team in the system that matches the given team id.
    #
    ...
    #
    #
    # @param		tID	the ID of the team which will be returned
    #
    # @return
    ...
    ## @brief         Gets the team in the system that matches the given sport and season year.
    #
    #        Calls the TeamDAO to get the team entry and maps the result
    ...
    #
    #
    # @param		sID	the ID of the sport of which the team will be returned
    # @param		tYear	the season year from which the team will be returned
    #
    # @return
    #            A JSON containing the team.
    #
    ...
    ## @brief         Gets the team members in the system that match the given team.
    #
    ...
    #
    #
    # @param		tID	the ID of the team of which members will be fetched
    #
    # @return
    ...
    ## @brief         Gets the team member entry in the system that matches the given athlete and team.
    #
    ...
    #
    #
    # @param		aID	the ID of the athlete from which the team member will be returned
    # @param		tID	the ID of the team from which the team member will be returned
    #
    # @return
    ...
    #
    #
    # @param		tID	the team to which members will be added
    #            tRoster:
    # @param		athlete_id	the id of an athlete that will be added to the team
    # @return
    ...
    #
    #
    # @param		tID	the team to which member will be added
    # @param		athlete_id	the id of an athlete that will be added to the team
    # @return
    #            A JSON containing containing the id for the updated team.
    #
    ...
    #
    #
    # @param		tID	the id of the team to be updated
    # @param		tImagelINK	the updated image link
    #
    # @return
    ...
    #
    #
    # @param		sID	the sport id of the team to be updated
    # @param		tYear	the season year of the team to be updated
    # @param		tImagelINK	the updated image link
    #
    # @return
    #            A JSON containing the the updated entry.
    ...
    ## @brief         Invalidates a team record in the database based on the given ID.
    #
    ...
    #
    #
    # @param		tID	the ID of the team for which the  record will be invalidated.
    #
    # @return
    ...
    #
    #
    # @param		sID	the sport ID of the team for which the  record will be invalidated.
    # @param		tYear	the season year of the team for which the  record will be invalidated.
    #
    # @return
    #            A JSON containing the id of the invalidated record.
    #
    ...
    #NEW
    ## @brief         Invalidates a team member record in the database based on the given ID.
    #
    ...
    #
    #
    # @param		aID	the athlete ID of the team member for which the  record will be invalidated.
    # @param		tID	the team ID of the team for which the  record will be invalidated.
    #
    # @return
    #            A JSON containing the id of the invalidated record.
    #
