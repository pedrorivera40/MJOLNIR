...
#=============================//POST//=======================
    ...
    def addTeamStatisticsAuto(self,eID):
        """
        Adds a new match_based event team statistics record with provided and existing information.
        ...
        query = """
                INSERT INTO match_based_event_team_stats(points,rebounds,assists,steals,blocks,turnovers,
