...
class AthleteDAO:
    ...
    def getAthletesBySport(self,sID):
        ...
        query = """select A.id,A.first_name,A.middle_name,A.last_names,A.short_bio,A.height_inches,A.study_program,A.date_of_birth,A.school_of_precedence,A.number,A.profile_image_link,A.is_invalid,S.name as Sport_name,P.name as position_name,C.name as category_name
