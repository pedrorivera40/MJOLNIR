...
export default {
  components: {
    ...
    created(){
      ...
      this.buildTable()
      this.getSeasonData()
      console.log("WHAT ARE MY HEADERS"+this.headers)
      console.log("WHAT ARE MY TEAM HEADERS"+this.team_headers)
      console.log("WHAT ARE MY SPORTID"+this.sport_id)
      console.log("WHAT ARE MY TEAM STATS PER SEASON"+this.team_statistics_per_season)
      console.log("WHAT ARE MY TEAM STATS PER SEASON"+this.team_statistics_per_season)
