<template>
  <div class="wrapper">
    <v-row v-if="formated_event_info()">
        <v-column>
                            ...
                            <v-card-title>
                                <v-row>
                                    <v-col>
                                        ...
                                        class="white--text" @click="addAthleteStatistics"><v-icon left>
                                            mdi-plus
                                            </v-icon>Añadir Estadisticas de Atleta</v-btn>
                                    </v-col>
                                    <!-- <v-col cols="4">
                                        <v-text-field
...
async created(){
  ...
  methods: {
    ...
    //   this.dialogEdit = true;
        ...
        console.log("KILL ME KILL ME KILL ME")
