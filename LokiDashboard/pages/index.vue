  ...
  <v-layout column class="wrapper">
    <v-flex xs12 sm8 md6>
      <div class="text-center">
        <h1 class="header my-12" dark>Welcome to Huella Deportiva Dashboard!</h1>
        <logo />
...
.wrapper {
  background: linear-gradient(-45deg, rgb(55, 141, 62),rgb(129, 185, 129), rgb(55, 141, 66), rgb(5, 36, 4));
