...
5. Create a new user from the user management page with a compliant password **[SW-R: 1a, 1b ]**.
6. Logout from the session **[SW-R: 5b, 6a, Sec-R: 3g, 3h]**
7. Try login in to an inactive account **[Sec-R: 2f, 3f]**.
...
11. Lock a User's account with 3 erroneous logins **[SW-R: 1h, Sec-R: 2e, 3e]**.
12. Reset a User's Password Using the User Management Page **[SW-R: 1j, 1k, Sec-R: 2h]**.
13. Edit a user's information **[SW-R: 1e]**.
14. Edit a User's Permissions **[SW-R: 1g]**.
15. Delete a user **[SW-R: 1f]**.
